#!/bin/sh
# Install reckoner from the latest GitHub release.
#
#   curl -fsSL https://raw.githubusercontent.com/Mattbusel/reckoner/main/install.sh | sh
#
...
# SHA256SUMS.txt, and copies one file (reckoner) into INSTALL_DIR. Nothing else.
set -eu

REPO="Mattbusel/reckoner"
PREFIX="reckoner"      # archive name prefix
BIN="reckoner"            # file name inside the archive
CMD="reckoner"            # command name you will type
...
case ":$PATH:" in
  *":$INSTALL_DIR:"*) say "Try it: reckoner --demo" ;;
  *) say ""
     say "$INSTALL_DIR is not on your PATH yet. Add this line to ~/.bashrc or ~/.zshrc:"
     say "  export PATH=\"$INSTALL_DIR:\$PATH\""
     say "Then open a new terminal and run: reckoner --demo" ;;
esac
