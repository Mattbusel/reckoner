# Install reckoner on Windows from the latest GitHub release.
#
#   irm https://raw.githubusercontent.com/Mattbusel/reckoner/main/install.ps1 | iex
#
# It downloads the Windows zip, checks it against the release's SHA256SUMS.txt,
# puts reckoner.exe in %LOCALAPPDATA%\Programs\reckoner and adds that folder to
...
Write-Host "Try it: reckoner --demo   (open a new terminal if the command is not found)"
